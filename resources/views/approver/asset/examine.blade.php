                    ...
                    <table id="myTable" class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <input type="checkbox" class="border-dark border-1" id="checkbox{{$row->id}}">
                                </td>
                                <td>
                                    <input type="text" class="form-control border-dark" id="textbox{{$row->id}" placeholder="--ระบุปัญหา--">
                                </td>
                                <style>
                                    input::placeholder {
